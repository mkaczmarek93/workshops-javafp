...
public class StreamsPart3CollectorsExercises {
	...
	public void countAverage() throws Exception {
		Double average = Stream.of(10, 20, 30, 40).collect(Collectors.averagingInt(Integer::intValue));
	...
	public void partitionToDigitAndNotDigit() throws Exception {
		Map<Boolean, List<String>> result = Stream.of("1", "a", "bbb", "20", "66", "lodz", "jug", "1000")
				.collect(Collectors.partitioningBy(s -> isNumeric(s)));
...
class CustomToLinkedListCollector<T> implements Collector<T, List<T>, List<T>> {
	...
	public Supplier<List<T>> supplier() {
		return LinkedList::new; //create new linkedlist
	}

	@Override
	public BiConsumer<List<T>, T> accumulator() {
		return List::add; //add element to list
	}
	...
	public BinaryOperator<List<T>> combiner() {
		...
		return combiner; // merge two lists
	}

	@Override
	public Function<List<T>, List<T>> finisher() {
		return Function.identity(); // return identity
	}
